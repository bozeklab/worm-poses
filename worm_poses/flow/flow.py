...
class SkelMapsFlow(Dataset):
    ...
    def __init__(self,
        ...
        self._input_names = list(
            set(dir(self)) - _dum)  # i want the name of this fields so i can access them if necessary
    ...
    def _get_random_mixup(self):
        ...
        crop_transforms = Compose(
            [AffineTransformBounded(crop_size_lims=(roi_size, roi_size), rotation_range=(0, 0),
